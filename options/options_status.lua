    ...
    local layout = function()
        ...
        _G[menu.value:GetName()..'Low']:SetText('|cffefce4b百分比 —|r'..percent..'%')
        _G[menu.value:GetName()..'High']:SetText(true_format(hp)..'|cffefce4b— 真实数值|r')
    end
    ...
    _G[menu.horizontal:GetName()..'Text']:SetText'切换水平对齐或默认状态文本位置的头像插件'
    ...
    menu.horizontal.warning:SetText'需重载 ui!'
    ...
    menu.horizontal.title:SetText'— 定位'
    ...
    menu.value:Hide()
    _G[menu.value:GetName()..'Text']:SetText'\% 或真实值文本,在状态栏'
    ...
    _G[menu.consolidate:GetName()..'Text']:SetText'显示真实 & \% 值在状态栏(禁用滑块选项)'
    ...
    menu.consolidate.warning:SetText'需重载 ui!'
    ...
    _G[menu.ctDMG:GetName()..'Text']:SetText'显示输出的伤害'
    ...
    _G[menu.ctHEAL:GetName()..'Text']:SetText'显示输出的治疗'
    ...
    menu.ctDMG.title:SetText'— 滚动战斗文字'
