    ...
    _G[menu.actionlayout:GetName()..'Text']:SetText'第三和第四动作条定位'
    _G[menu.actionlayout:GetName()..'Low']:SetText'底排'
    _G[menu.actionlayout:GetName()..'High']:SetText'默认'
    ...
    menu.actionlayout.title:SetText'— 按钮布局'
    ...
    _G[menu.keydown:GetName()..'Text']:SetText'施放在向下的按键 (推荐 Faster Skill-Casts)'
    ...
    _G[menu.keydown.selfcast:GetName()..'Text']:SetText'自我施放法术 Alt + [按键]'
