    ...
    menu.gryphon:Hide()
    _G[menu.gryphon:GetName()..'Low']:SetText'狮鹫'
    _G[menu.gryphon:GetName()..'High']:SetText'狮子'
    _G[menu.gryphon:GetName()..'Text']:SetText'两边纹理开关'
    ...
    menu.gryphon.title:SetText'— 主条狮鹫设置'
    ...
    _G[menu.endcap:GetName()..'Text']:SetText'切换显示主菜单两边纹理'
    ...
    _G[menu.chatstamp:GetName()..'Text']:SetText'切换聊天信息时间戳'
    ...
    menu.chatstamp.title:SetText'— 聊天框信息'
    ...
    _G[menu.chatformat:GetName()..'Text']:SetText'切换自定义聊天频道的格式.'
    ...
    _G[menu.itemlink:GetName()..'Text']:SetText'切换去除 |cffc600ff[装备]|r 物品链接.'
    ...
    _G[menu.chateditbox:GetName()..'Text']:SetText'输入框移动到聊天框上方.'
    ...
    _G[menu.auraformat:GetName()..'Low']:SetText'整数'
    _G[menu.auraformat:GetName()..'High']:SetText'H:M:S'
    _G[menu.auraformat:GetName()..'Text']:SetText'buff持续时间格式'
    ...
    menu.auraformat.title:SetText'— Buff'
    ...
    _G[menu.targetaura:GetName()..'Text']:SetText'在框架上方显示BUFF'
    ...
    _G[menu.tooltip:GetName()..'Text']:SetText'切换工具提示移动框'
    ...
    _G[menu.tooltip.cursor:GetName()..'Text']:SetText'将工具提示附加到鼠标'
    ...
    _G[menu.castbar:GetName()..'Text']:SetText'在头像下方显示施法条'
    ...
    _G[menu.castbar.target:GetName()..'Text']:SetText'目标施法条位置移动'
    ...
    menu.castbar.title:SetText'— 施法条'
    ...
    menu.castbar.target:SetScript('OnClick', function()
        ...
        if  this:GetChecked() == 1 then
            ...
            TargetFrame.cast.text:SetText'寒冰箭'
            TargetFrame.cast.timer:SetText'2.5秒'
