    ...
    _G[menu.allelement:GetName()..'Text']:SetText'切换所有工具 开/关'

    _G['modui_element1Text']:SetText'包裹整合'
    _G['modui_element2Text']:SetText'地图增强 (战场)'
    _G['modui_element3Text']:SetText'地图增强 (世界)'
    _G['modui_element4Text']:SetText'副本地图'
    _G['modui_element5Text']:SetText'姓名板增强'
    _G['modui_element6Text']:SetText'目标跟踪增强'
    _G['modui_element7Text']:SetText'提示工具增强'
    _G['modui_element8Text']:SetText'单位框架增强'
    _G['modui_element9Text']:SetText'PvP 战场计时器'
    _G['modui_element10Text']:SetText'PvP 等级跟踪'
    _G['modui_element11Text']:SetText'秒表'
    _G['modui_element12Text']:SetText'冷却时间计数'
    ...
    menu.elements.title:SetText'— 工具'
    ...
    menu.elements.description:SetText'切换modui的单个组件工具的开关.'
