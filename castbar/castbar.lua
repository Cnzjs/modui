    ...
    local overrideIcons = {
        ['炉石']    = [[Interface\Icons\inv_misc_rune_01]],
        ['采集草药'] = [[Interface\Icons\spell_nature_naturetouchgrow]],
        ['采矿']         = [[Interface\Icons\trade_mining]],
        ['钓鱼']        = [[Interface\Icons\trade_fishing]],
        ['瞄准射击']     = [[Interface\Icons\inv_spear_07]]
    }
